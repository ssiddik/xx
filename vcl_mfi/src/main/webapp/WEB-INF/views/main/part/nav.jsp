                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> CB Dashboard <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i>  Master  <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="master">
                          <i class="fa fa-caret-right"></i>  Master
                        </a>
                      </li>
                  ...
                  <li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> CIVIL  <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="cibil_check">
                          <i class="fa fa-caret-right"></i> Cibil Check
                        </a>
                      </li>
					...
					<li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> Group <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="GroupCreation">
                          <i class="fa fa-caret-right"></i> Group Details
                        </a>
                      </li>
				  ...
				  <li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-list"></i> CGT/GRT/BLC/LA/PRE/POST <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="cgt_grt_blc_loan_pre_post">
